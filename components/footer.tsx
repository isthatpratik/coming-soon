...
const Footer = () => {
  return (
    <footer className="w-full bg-[url('/images/footer.jpg')] bg-cover bg-top bg-no-repeat px-4 py-10 shadow-[0_-8px_0_0_#7E7367] rounded-t-2xl">
      <div className="max-w-[1920px] mx-auto md:px-15">
        <div className="flex flex-col justify-between items-start h-full gap-10">
          {/* Logo and Tagline */}
          <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-4 sm:space-y-0 sm:space-x-4 mb-6 md:mb-0">
            <Image
          ...
          {/* Links and Copyright */}
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center w-full  md:pt-10 space-y-4 sm:space-y-0">
